## !This repository is fork of https://github.com/big-data-europe/docker-hadoop-spark-workbench!

First we need to create docker swarm cluster, in our case we using Digital Ocean cloud computing platform 
Tutorial based on [a link](https://www.digitalocean.com/community/tutorials/how-to-create-a-cluster-of-docker-containers-with-docker-swarm-and-digitalocean-on-ubuntu-16-04)
